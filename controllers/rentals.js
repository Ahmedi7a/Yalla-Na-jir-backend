...
const Rentals = require('../models/car.js');
...
// Get rentals for dealer's cars (dealer-only) add isDealer middleware here 
router.get('/dealer-rentals', async (req, res) => {
  try {
...
// Approve or reject rental (dealer-only) add isDealer middleware here 
